...
class ViewTest < ActiveSupport::TestCase
  test "top urls grouped by date and are within past 5 days" do
    tops_urls = View.top_urls_grouped_by_past_days(5)
  ...
  test "top urls has correct number of visits" do
    past_days = 5
    tops_urls = View.top_urls_grouped_by_past_days(past_days)
  ...
  test "top referrers grouped by date and are within past 5 days" do
    tops_referrers = View.top_urls_grouped_by_past_days(5, :with_referrers)
  ...
  test "top referrers visits per url sum up to url visits " do
    top_referrers = View.top_urls_grouped_by_past_days(5, :with_referrers)
  ...
  test "top referrers has correct number of visits" do
    past_days = 5
    tops_urls = View.top_urls_grouped_by_past_days(past_days, :with_referrers)
    tops_urls.each{ |date, views|
    	views.each do |view|
